# Spec: remote-data-source

## Purpose

Defines the Ktor HTTP client setup, the serializable DTOs that model the Rick and Morty API responses, and the `CharacterRemoteDataSource` contract with its Hilt wiring.
